...
export class LEDStripAccessory {
  ...
  constructor(private readonly platform: LEDStripPlatform, private readonly accessory: PlatformAccessory, private readonly device: DeviceConfig) {
    this.accessory
    ...
    this.service.getCharacteristic(this.platform.Characteristic.Hue).onSet(this.setHue.bind(this)).onGet(this.getHue.bind(this));

    this.service.getCharacteristic(this.platform.Characteristic.Saturation).onSet(this.setSaturation.bind(this)).onGet(this.getSaturation.bind(this));
  }
  ...
  private updateColor(): void {
    const { red, green, blue } = this.HSVtoRGB(this.state.Hue, this.state.Saturation, this.state.Brightness);
